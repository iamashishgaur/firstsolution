          ...
          <div className="writepen col-lg-6 col-md-12 col-sm-12">
            ...
            <div className="mt-2">
              <p className="abouttext">
                A team of first generation entrepreneurs promotes First Solution
                global organizations in recruitment & resourcing, solution
                development, people management, administration and marketing.
                First Solution understand what it takes a company to hire the
                right professional for the right position.
              </p>
              <p className="abouttext">
        ...
        <div className="row ">
          <div className="writepen col-lg-12 col-md-12 col-sm-12">
            ...
            <p className="abouttext" style={{ marginTop: "20px" }}>
              Given the mix of collective skills & experience, commitment to
              deadlines and a strong culture of ethics. In keeping with the
              current industry requirements, First Solution has developed a mix
              of professionals with domain and functional experience, who act as
              a like-minded sounding board to the customer - who could be an
              organization or a candidate.
            </p>
            <div className="mt-2">
              ...
              <p className="abouttext">
                ...
                providing superior value-added service to our clients and
              ...
              <p className="abouttext">
                ...
                organizational Human Resource needs. With the right combination
                of robust delivery models and measured processes, we are
                committed to a long-term partnership with our clients.
              </p>
              ...
              <p className="abouttext">
                ...
                the specific search universe from which suitable candidates can
                be sourced. We then decide which one or more methods to use for
                sourcing the candidates - through advertisements, referrals,
                headhunting and referring to our extensive database.
              </p>
              <p className="abouttext">
              ...
              <p className="abouttext">
                ...
                competitive, new economy firms who value commitment and quality
                from their business partners. First Solution strive to meet
                their expectations and are proud to be associated with such
                clients.
              </p>
              <h2 style={{ fontWeight: "bold", marginTop: "20px" }}>
                Recruitment :)
              ...
              >
                ...
                <p className="abouttext d-flex gap-3 align-items-center">
                  <FaRegCheckCircle size={30} style={{ color: "green" }} />
                  Understand the organizational needs and derive specific models
                  for fulfilling them.
                </p>
